...
In this lab we'll bind our RESTful web service from link:../lab_05/lab_05.html[Lab 5] to a PostgreSQL database and leverage Spring Cloud Connectors to easily connect to it.

NOTE: The completed code for this lab can be found at `$COURSE_HOME/session_04/lab_06/complete/cities`.
...
+
----
$ cd $COURSE_HOME/session_04/lab_06/initial/cities
----
